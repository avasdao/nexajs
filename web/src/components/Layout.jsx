...
const navigation = [
    {
        ...
        links: [
            ...
            { title: 'Builder Studio', href: '/studio' },
    ...
    },
    {
        ...
        links: [
            ...
            { title: 'Message', href: '/pkg/message' },
            { title: 'Purse', href: '/pkg/purse' },
            { title: 'Rostrum', href: '/pkg/rostrum' },
            { title: 'Script', href: '/pkg/script' },
            { title: 'Token', href: '/pkg/token' },
            { title: 'Utilities', href: '/pkg/utils' },
    ...
    return (
        ...
        >
            ...
            <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
                ...
                <Link href="https://github.com/avasdao/nexajs" className="group" aria-label="GitHub">
