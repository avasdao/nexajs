<template>
    <main class="relative bg-white">
        <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            ...
            <nav class="hidden md:flex space-x-10">
                <a href="https://explorer.nexa.org/" target="_blank" class="text-base font-medium text-gray-500 hover:text-gray-900">
                    Block Explorer
                </a>
                ...
                <div class="relative">
                    ...
                    <button
                        type="button"
                        class="px-2 text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        aria-expanded="false"
                    >
                        <span>Solutions</span>
                        <!--
        ...
        -->
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                <a href="javascript://" class="ml-8 whitespace-nowrap inline-flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white hover:from-purple-700 hover:to-indigo-700">
                    Sign in
                </a>
            </div>
        </div>
  ...
  -->
        <div class="hidden absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
            <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                <div class="pt-5 pb-6 px-5">
                    <div class="flex items-center justify-between">
                        <div>
                            <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-purple-600-to-indigo-600.svg" alt="NexaJS" />
                        </div>
                        <div class="-mr-2">
                            <button
                                type="button"
