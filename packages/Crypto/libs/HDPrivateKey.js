...
const _emptyBuffer = function (bytes) {
 ...
 */
const HDPrivateKey = function (arg) {
...
HDPrivateKey._validateNetwork = function (data, networkArg) {
    ...
    if (_integerFromBuffer(version) !== network.xprivkey) {
...
HDPrivateKey.prototype._generateRandomly = function (network) {
    return HDPrivateKey.fromSeed(Buffer.from(randomBytes(64)), network)
}
...
HDPrivateKey._validateBufferArguments = function (arg) {
    const checkBuffer = function (name, size) {
        ...
        if (!Buffer.isBuffer(buff)) {
            throw new Error(name + ' argument is not a buffer.')
        }
...
HDPrivateKey.prototype.toObject = HDPrivateKey.prototype.toJSON = function () {
    return {
        network: Network.get(_integerFromBuffer(this._buffers.version), 'xprivkey').name,
...
HDPrivateKey.prototype.toBuffer = function () {
    return Buffer.copy(this._buffers.xprivkey)
}
