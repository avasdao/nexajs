 ...
 * @constructor
 */
const Address = function (data, network, type) {
...
const decodeCashAddress = function (address) {

    const hasSingleCase = function (string) {
    ...
    const validChecksum = function (prefix, payload) {
    ...
    const getType = function (versionByte) {
...
Address.prototype.toCashAddress = function (stripPrefix) {
    const getTypeBits = function (type) {
        switch (type) {
        case 'pubkeyhash':
            return 0
        case 'scripthash':
    ...
    const getHashSizeBits = function (hash) {
 ...
 */
const getHashSize = function (versionByte) {
 ...
 */
const checksumToArray = function (checksum) {
    var result = []
