...
describe( 'Message Test Suite', () => {
    ...
    describe( 'Message -> Sign a message', () => {
        it( 'should return the signature details', async () => {
            let nexaAddress
            let publicKey
            let publicKeyHash
            let scriptData
    ...
    describe( 'Message -> Signature Verification', () => {
        it( 'should return true/false when provided with a message and signature', async () => {
            const msg = '1336'
            ...
            expect(verification.hex).to.equal('')
            expect(verification.sig).to.equal('')
        } )
    } )
