...
const debugRostrum = () => {
    ...
    const result = Rostrum.bAddressDecode('nexa:...')
    console.log('ROSTRUM RESULT', result)

}

/* Create new Nexa instance. */
const nexa = new Nexa()

/* Handle test. */
nexa.on('test', (_msg) => {
    console.log('TEST SAID THIS', _msg)
})

/* Call test. */
console.log('NEXA (Instance) TEST', nexa.test())
console.log('NEXA (Static) TEST', Nexa.test())
