...
return
            ...
            expect(process.env.ALICE_TOKENID_HEX).to.have.length(64)
            ...
            // NOTE: Currently limited to a "single" Id.
            tokens = tokens.filter(_token => {
                return _token.tokenidHex === process.env.ALICE_TOKENID_HEX
            })
            ...
            receivers = [
                ...
                {
                    address: _receiver,
                    tokenid: process.env.ALICE_TOKENID_HEX, // TODO Allow auto-format conversion.
