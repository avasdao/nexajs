...
const WISER_SWAP_HEX = ''
...
return
            ...
            // fee = 0x012c // 300 (3.00%)
            fee = OP.ZERO // 0 (0.00%) FOR DEV PURPOSES ONLY
            coinFloor = OP.ZERO // 0 (0.00%) FOR DEV PURPOSES ONLY
            tokenFloor = OP.ZERO // 0 (0.00%) FOR DEV PURPOSES ONLY
            ...
            scriptPubKey = new Uint8Array([
                ...
                ...encodeDataPush(adminPkh), // An optional 3rd-party (specified by the Seller) used to facilitate the tranaction.
                fee, // An optional amount charged by the Provider. (measured in <basis points> (bp), eg. 5.25% = 525bp)
                coinFloor, // An optional (trade) floor set by the Provider. (measured in <satoshis> per <asset>)
                tokenFloor, // An optional (trade) floor set by the Provider. (measured in <asset> per <satoshis>)
            ])
            console.info('\nSCRIPT PUBLIC KEY', binToHex(scriptPubKey))
            ...
            receivers.push({
                ...
                tokenid: tokenidHex,
                // tokens: (unspentTokens - 1000n),
                tokens: (contractTokens[0].tokens + 100n),
            })

            /* Add primary (token change). */
            receivers.push({
                address: primaryAddress,
                tokenid: tokenidHex,
...
// return
            ...
            // receivers.push({
            //     address: primaryAddress,
            //     satoshis: 546n, // initial (1M) value
            // })
