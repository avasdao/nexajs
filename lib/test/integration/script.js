...
// return
            ...
            // const paramsScript = new Uint8Array([
            //     OP.THREE, // FOR DEV PURPOSES
            // ])

            // const paramsConstraint = ripemd160(sha256(paramsScript))
            // const paramsConstraint = hexToBin('028116f7888e1f93f0e7391d5c874b9519ef7864') // 0x53
            const paramsConstraint = hexToBin('10c4b0a9966330714215c6e51ee885f149a02f3e') // 0x5356
            console.log('PARAMS CONSTRAINT', binToHex(paramsConstraint))
            ...
            scriptPubKey = new Uint8Array([
                ...
                ...encodeDataPush(paramsConstraint), // HASH160(args script) or empty stack item
