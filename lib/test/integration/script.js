...
// const AVAS_TOKENID_HEX = '57f46c1766dc0087b207acde1b3372e9f90b18c7e67242657344dcd2af660000'
...
describe( 'Script Test Suite', () => {
    before( async () => {
        console.info( `  ↳ targeting all (private on-chain) JavaScript methods provided by the 'Script' class.` )
...
// return
            ...
            receivers = [
                ...
                // {
                //     address: NEXA_DUMP_ADDRESS,
                //     tokenid: AVAS_TOKENID_HEX, // TODO Allow auto-format conversion.
                //     tokens: 1n,
                // },
            ]
