...
describe( 'Address Test Suite', function () {
    ...
    describe( 'encoding', function () {
        ...
        it( 'should match the address', function () {
            expect(address).to.equal(NEXA_TEST_ADDRESS)
        } )
    } )
    ...
    describe( 'decoding', function () {
        ...
        it( 'should match the (Uint8Array) hash', function () {
            expect(hash).to.eql(HASH_VERIFY)
        } )
    } )
