...
describe( 'Script Test Suite', () => {
    ...
    describe( 'Script -> UTXO -> Send Script', async () => {
        it( 'should prepare and sign a (Script) UTXO for broadcast to the network', async () => {
            ...
            /* Send UTXO request. */
            // response = await wallet.send(
            //     'nexa:nqkqq9qsxqf0kxfv0hpfl2ct7yfxml9yyyr22aq5sjkqk7wzd9wwh9423rr0tda7m027rylj2gk07zuus4',
            //     3000n
            // )
            // return console.log('Send (Coin) UTXO (response):', response)
