...
describe( 'Script Test Suite', () => {
    ...
    describe( 'Script -> UTXO -> Send Script', async () => {
        it( 'should prepare and sign a (Script) UTXO for broadcast to the network', async () => {
            ...
            // FIXME FOR DEV ONLY
            blockHeight = BigInt(301337)

            if (blockHeight > BigInt(0xFFFFFFFF)) {
                blockHeight = bigIntToBinUint64LE(blockHeight)
            } else if (blockHeight > BigInt(0xFFFF)) {
                blockHeight = bigIntToBinUint32LE(blockHeight)
            } else {
                blockHeight = bigIntToBinUint16LE(blockHeight)
            }
            ...
            scriptPubKey = new Uint8Array([
                ...
                // ...encodeDataPush(blockHeight), // block height
