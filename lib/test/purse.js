...
describe( 'Purse Test Suite', () => {
    ...
    describe( 'Purse -> UTXO -> BroadcastTransaction', () => {
        it( 'should prepare and sign an UTXO for broadcast to the network', async () => {
            ...
            const privateKey = hexToBin('3e36d3622f5adad01080cc2120bb72c0714ecec6118eb9523586410b7435ae80')//node.privateKey
            ...
            expect(binToHex(privateKey)).to.equal('3e36d3622f5adad01080cc2120bb72c0714ecec6118eb9523586410b7435ae80')

            /* Derive the corresponding public key. */
            const publicKey = secp256k1.derivePublicKeyCompressed(privateKey)
            // console.log('PUBLIC KEY', publicKey)
            // console.log('PUBLIC KEY (hex)', binToHex(publicKey))
            expect(binToHex(publicKey)).to.equal('03cbe16ecb57d7a173ef5d46692daf38f366e2939b655817335fbfcd8a4edc41c0')
            ...
            expect(binToHex(publicKeyHash)).to.equal('ea48f422ca705f49e9cff69ee27b5ad9e0ff2976')

            const pkhScript = hexToBin('17005114' + binToHex(publicKeyHash))
            console.info('  Public key hash Script:', binToHex(pkhScript))
            expect(binToHex(pkhScript)).to.equal('17005114ea48f422ca705f49e9cff69ee27b5ad9e0ff2976')
            ...
            expect(nexaAddress).to.equal('nexa:nqtsq5g5afy0ggk2wp05n6w0760wy766m8s072tkx79t63xl')

            // Encode Private Key WIF.
            const privateKeyWIF = encodePrivateKeyWif(sha256, privateKey, 'mainnet')
            // console.log('PRIVATE KEY (WIF):', privateKeyWIF)
            expect(privateKeyWIF).to.equal('6DP1K33whLGGSkBhCaGZXqnfoRtP5LKimqfKap45sLNgLG4SGwrv') // Nexa (`6` or `??`)
