...
describe( 'Purse Test Suite', () => {
    ...
    describe( 'Purse -> UTXO -> BroadcastTransaction', () => {
        it( 'should prepare and sign an UTXO for broadcast to the network', async () => {
            ...
            expect(binToHex(pkhScript)).to.equal('170051141c65f11b76edf298f9b1e0602a0514edec575b2e')
                                               // 1700511484ac0b79c2695ceb96aa88c6f5b7bedbd5e193f2
            ...
            // expect(privateKeyWIF).to.equal('L4Dbz56QG1NQKdvND6yC7tWfDR7vnRUXpianeAmFT4qsaJLrKC8u') // Bitcoin Cash (`K` or `L`)
