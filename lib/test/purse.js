...
describe( 'Purse Test Suite', () => {
    ...
    describe( 'Purse -> Ethers -> MnemonicToEntropy', () => {
        it( 'should generate 128-bits of entropy from 12-word mnemonic', async () => {
    ...
    describe( 'Purse -> Ethers -> EntropyToMnemonic', () => {
        ...
        it( 'should generate a 12-word mnemonic from 128-bits of entropy', async () => {
    ...
    describe( 'Purse -> Ethers -> MnemonicToSeed', () => {
        it( 'should generate a 512-bit seed from a 12-word mnemonic', async () => {
