...
import { sendCoinMulti } from '../index.js'
...
// const wif2 = await parseWif('6HSwDTXyx6ovceRn3s2muuUfbPwnPdT6BnPg3MAxJXkk6ZjS7zij')
// console.log('WIF', wif2)
// nexa:qr3yc3c83pgm2lrpst56xjc05m0360wh4qrp87qcys
// nexa:qr3yc3c83pgm2lrpst56xjc05m0360wh4qrp87qcys
// 6HSwDTXyx6ovceRn3s2muuUfbPwnPdT6BnPg3MAxJXkk6ZjS7zij
// 6HSwDTXyx6ovceRn3s2muuUfbPwnPdT6BnPg3MAxJXkk6ZjS7zij
            ...
            // const scriptPubKey = hexToBin('170014691bc2935439e924ca8cae5d7b97c35f8eccfbd500')
            ...
            /* Send UTXO request. */
            const response = await sendCoinMulti(coins, receivers, autoFee)
...
return
            /* Encode Private Key WIF. */
            const wif = encodePrivateKeyWif(sha256, hexToBin(PRIVATE_KEY_1), 'mainnet')
            // console.log('PRIVATE KEY (WIF):', wif)

            /* Derive the corresponding public key. */
            const publicKey = secp256k1.derivePublicKeyCompressed(hexToBin(PRIVATE_KEY_1))
