...
describe( 'Wallet Test Suite', () => {
    ...
    describe( 'Wallet -> Update Balances', () => {
        it( 'should request UPDATED BALANCES for all assets', async () => {
            ...
            const balances = await wallet.updateBalances()
            console.log('BALANCES', balances)
            console.log('BALANCES (token)', balances.tokens)

            expect(balances.coins.fiat.USD).to.be.gt(0)
        } )
    } )
